...
- **chore(codex):** retire exact-owned legacy instruction and compaction activation only after the canonical skill, cue, checkpoint CLI/MCP adapters, and Stop verifier are ready; preserve customized or ambiguous state and keep failed upgrades on the prior working path.
