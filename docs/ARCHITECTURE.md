...
engram recall-study verify|dry-run|plan-calibration|report|run-calibration|run-held-out|publish|verify-distribution
                          Verify, execute, publish, or validate the applied frozen Recall outcome [--json]
