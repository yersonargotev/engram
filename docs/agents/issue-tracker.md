...
- **Apply / remove labels (maintain/admin only)**: `gh issue edit <number> --add-label "..."` / `--remove-label "..."`
...
- **Comment / label / close**: `gh pr comment`, `gh pr edit --add-label`/`--remove-label` (maintain/admin only), `gh pr close`.
