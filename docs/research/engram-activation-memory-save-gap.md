...
| Evidence/lifecycle capture | Session and prompt hooks; explicit summary/save calls | Sessions, prompts, summaries, explicit Memories | Captured prompts are evidence, not Memories. Codex `UserPromptSubmit` persists prompts in a detached best-effort request ([`plugin/codex/scripts/user-prompt-submit.sh:32-48`](../../plugin/codex/scripts/user-prompt-submit.sh)). |
...
Only the Codex `SubagentStop` hook posts assistant output to passive capture ([`plugin/codex/hooks/hooks.json:38-48`](../../plugin/codex/hooks/hooks.json), [`plugin/codex/scripts/subagent-stop.sh:18-39`](../../plugin/codex/scripts/subagent-stop.sh)). The extractor ignores prose outside a recognized learning section and drops short items. This explains why valid work can yield no passive Memories without any explicit rejection.
...
- Codex lifecycle: [`plugin/codex/hooks/hooks.json`](../../plugin/codex/hooks/hooks.json), [`plugin/codex/scripts/user-prompt-submit.sh`](../../plugin/codex/scripts/user-prompt-submit.sh), [`plugin/codex/scripts/subagent-stop.sh`](../../plugin/codex/scripts/subagent-stop.sh), [`plugin/codex/skills/memory/SKILL.md`](../../plugin/codex/skills/memory/SKILL.md).
